...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Oğuzhan Ötleş
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm 23 years old. I am a computer engineering student. I am improving to
                myself to gain professional experience. My passion is computer science
                and new technologies. I'm a hard working person, I learn quickly.</p>
